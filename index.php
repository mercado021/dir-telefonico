			...
			<header>
				...
				<div>
					...
					<nav class='row main-menu'>
						...
						<div class=" dropdown navbar-right btn-pading-right">
							...
							<a class="btn btn-success dropdown-toggle navbar-btn " data-toggle="dropdown" href="#dropdown-menu">Locaciones</a>
			...
			<div class="row">
				<aside class="col-sm-2 ">
					<fieldset class="form-group">
						...
						<label for="origen">Me encuentro en... 
						...
						<label for="destino"> Quiero marcar a...
						...
						<button class=" btn btn-default" type="submit" name="enviando" onclick="ajax_post();" value="¿Cómo marco?"> ¿Cómo marco?</button>
					</fieldset> 
					<div id="marcadito">
						
						</div>
				</aside>
				<main id="lista" class="col-xs-10 table-responsive">
			...
			<div class="modal-content modal-dialog modal-md">
				...
				<div class="modal-body">
					<form action='mail.php' method='post'>
						<label>Cual es tu correo?</label>
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon"> <i class="glyphicon glyphicon-envelope"></i></span>
								<input class="form-control" title="Se usará para notificarte cuando se aplique tu sugerencia" type="email" name="mail" placeholder="Tu correo ">
							</div>
							<br>
						...
						<div class="row col-sm-12 form-group">
								<div class="input-group">
									...
									<input class="form-control" placeholder="Departamento" type="text" name="depto">
								</div>	
								<div class="input-group">
								...
								<div class="input-group">
									...
									<textarea class="form-control" placeholder="Comentarios Adicionales" name="comentarios" rows="3" cols="22"></textarea>
								</div>	
						</div>	
		...
		<script>
			...
			function loadDoc() {
				...
				xhttp.onreadystatechange = function() {
					...
					document.getElementById("marcadito").innerHTML = this.responseText;
					}
				};
				xhttp.open("POST", "callfromhotel.php", true);
				xhttp.send(consulta);
			}

			function ajax_post(){
				var ajaxRequest;
				//pregunta que tipo de navegador está usando para  
				//inicializar el objeto ajax
				...
				//Aquí se manda la solicitud al backend. Cuando éste responda
				//se procesará la respuesta en la función anterior "ajaxRequest.onreadystatechange"
